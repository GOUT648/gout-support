...
const translations = {
    en: {
        ...
        support: "Support",
        careers: "Careers",
        copyright: "© 2023 GOUT. All rights reserved.",
        ...
        who_we_are_text: "LearnZy is an educational platform helping children learn mathematics in a personalized, interactive way. We're Team GOUT (#26.4 in Startup School Moldova) - innovators in educational technology.",
    ...
    ro: {
        ...
        support: "Suport",
        careers: "Cariere",
        copyright: "© 2023 GOUT. Toate drepturile rezervate.",
        ...
        who_we_are_text: "LearnZy este o platformă educațională care ajută copiii să învețe matematica într-un mod personalizat și interactiv. Suntem Echipa GOUT (#26.4 în Startup School Moldova) - inovatori în tehnologia educațională.",
        ...
        core_team: "Echipa de Bază",
        role_dev: "Developer Full-stack",
        role_frontend: "Developer Front-end",
...
function applyTranslations(lang) {
    ...
    // Update form language hidden field if exists
    const formLangInput = document.getElementById('form-language');
...
function initAIAssistant() {
    ...
    aiToggle.addEventListener('click', () => {
        aiActive = !aiActive;
        aiAssistant.style.display = aiActive ? 'block' : 'none';
    });
    ...
    function getAIResponse(message) {
        ...
        if (lowerMsg.includes('complaint') || lowerMsg.includes('problem')) {
            return currentLanguage === 'en' 
                ? "You can submit complaints on our support page." 
                : "Puteți trimite reclamații pe pagina noastră de suport.";
        } else if (lowerMsg.includes('job') || lowerMsg.includes('career')) {
            return currentLanguage === 'en'
                ? "Check our careers page for open positions."
                : "Verificați pagina noastră de cariere pentru posturi disponibile.";
        } else if (lowerMsg.includes('about') || lowerMsg.includes('despre')) {
            return currentLanguage === 'en'
                ? "Learn more about us on the About page."
                : "Aflați mai multe despre noi pe pagina Despre Noi.";
        } else {
            return currentLanguage === 'en'
                ? "I'm GOUT's AI assistant. How can I help you today?"
                : "Sunt asistentul AI al GOUT. Cum vă pot ajuta astăzi?";
        }
    }
    ...
    setTimeout(() => {
        addMessage('ai', currentLanguage === 'en' 
            ? "Hello! I'm GOUT's AI assistant. How can I help you today?" 
            : "Bună! Sunt asistentul AI al GOUT. Cum vă pot ajuta astăzi?");
    }, 1500);
}
            ...
            setTimeout(() => {
                ...
                successDiv.innerHTML = '<i class="fas fa-check-circle"></i> ' + 
                    (currentLanguage === 'en' 
                        ...
                        : 'Reclamația dumneavoastră a fost trimisă!');
